# -*- coding: utf-8 -*-
# Generated by Django 1.9.2 on 2016-05-19 17:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_active', models.BooleanField(default=False, help_text='Вместо удаления аккаунта, сделайте его неактивным', verbose_name='Активность')),
                ...
                ('is_organizer', models.BooleanField(default=False, help_text='Создает игры, назначает ответственных', verbose_name='Организатор')),
                ('is_admin', models.BooleanField(default=False, help_text='Работает с пользователями, площадками и финансами', verbose_name='Админ')),
                ...
                ('banned', models.BooleanField(default=False, help_text='Сделать активным для бана', verbose_name='Забанен')),
